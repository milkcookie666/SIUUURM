...
CREATE TABLE `client_info` (
  `id_column_name` int NOT NULL AUTO_INCREMENT,
...
INSERT INTO `client_info` VALUES (1,'Имя'),(2,'Фамилия'),(3,'Отчество'),(4,'Номер телефона'),(5,'Адрес проживания'),(6,'email'),(7,'Описание'),(8,'Дата рождения');
