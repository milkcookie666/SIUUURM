...
CREATE TABLE `sales_plan` (
  `sales_plan_id` int NOT NULL AUTO_INCREMENT,
  `month_number` int NOT NULL,
  `year_number` int NOT NULL,
  `sales_plan` decimal(12,2) NOT NULL,
  `manager_id` int NOT NULL,
  PRIMARY KEY (`sales_plan_id`),
  KEY `relation_7` (`manager_id`),
  CONSTRAINT `relation_7` FOREIGN KEY (`manager_id`) REFERENCES `managers` (`manager_id`) ON DELETE CASCADE
